namespace Exemplar.Data.Configuration
{
    ...
    public class AuthorizePaymentTransactionConfiguration : IEntityTypeConfiguration<AuthorizePaymentTransaction>
    {
        public void Configure(EntityTypeBuilder<AuthorizePaymentTransaction> builder)
        {
            builder.ToTable("AuthorizePaymentTransaction", "dbo");
