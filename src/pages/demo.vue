    ...
    <TabGroup :selected-index="selectedTab" @change="changeTab">
      <div class="sm:hidden">
        ...
        <div class="relative mt-1">
          <div class="relative">
            <select id="category" v-model="selectedTab" name="category" class="form-select relative block w-full border-0 rounded-md bg-white px-2.5 py-1.5 pe-9 text-sm text-gray-900 shadow-sm ring-1 ring-gray-300 ring-inset disabled:cursor-not-allowed dark:bg-gray-900 dark:text-white disabled:opacity-75 focus:outline-none focus:ring-2 dark:ring-gray-700 focus:ring-primary-500 dark:focus:ring-primary-400">
